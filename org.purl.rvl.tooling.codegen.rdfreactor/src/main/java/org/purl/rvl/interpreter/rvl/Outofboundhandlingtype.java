 ...
 */
public class Outofboundhandlingtype extends Thing {
	 ...
	 */
	protected Outofboundhandlingtype ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Outofboundhandlingtype ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public static Outofboundhandlingtype  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
    ...
    /**
	 * Remove rdf:type Outofboundhandlingtype from this instance. Other triples are not affected.
