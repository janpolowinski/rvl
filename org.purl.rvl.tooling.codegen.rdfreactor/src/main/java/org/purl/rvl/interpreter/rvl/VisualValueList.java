 ...
 */
public class VisualValueList extends Thing {
	 ...
	 */
	protected VisualValueList ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public VisualValueList ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public static VisualValueList  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
    ...
    /**
	 * Remove rdf:type VisualValueList from this instance. Other triples are not affected.
	 ...
	 */
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllTargetvalues_abstract__Inverse( Model model, Object objectValue) {
	 ...
	 */
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllTargetvalues_abstract__Inverse() {
	 ...
	 */
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllTargetvalues_abstract__Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Valuemapping.TARGETVALUES_ABSTRACT_, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}
