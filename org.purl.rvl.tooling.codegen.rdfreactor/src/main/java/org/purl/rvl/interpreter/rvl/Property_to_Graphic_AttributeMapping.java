...
public class Property_to_Graphic_AttributeMapping extends PropertyMapping {
    ...
    private static final long serialVersionUID = -3349097972811507181L;
     ...
     */
	public static ClosableIterator<Thing1> getAllDrawinterpolated(Model model, Resource instanceResource) {
		return Base.getAll(model, instanceResource, DRAWINTERPOLATED, Thing1.class);
	}

    /**
     * Get all values of property {@code Drawinterpolated} as a ReactorResult of {@linkplain Thing1}.
     * Comment from schema: This flag will cause the graphic to show source values that do not exist in the raw dataset, but have only been interpolated! Therefore, this setting has to be done with care not to suggest the impression of continuous data, when only discrete source values exist.
     *
     * @param model an RDF2Go model
     * @param instanceResource an RDF2Go resource
     ...
     */
	public static ReactorResult<Thing1> getAllDrawinterpolated_as(Model model, Resource instanceResource) {
		return Base.getAll_as(model, instanceResource, DRAWINTERPOLATED, Thing1.class);
	}
     ...
     */
	public ClosableIterator<Thing1> getAllDrawinterpolated() {
		return Base.getAll(this.model, this.getResource(), DRAWINTERPOLATED, Thing1.class);
	}
     ...
     */
	public ReactorResult<Thing1> getAllDrawinterpolated_as() {
		return Base.getAll_as(this.model, this.getResource(), DRAWINTERPOLATED, Thing1.class);
	}
    ...
    /**
     * Adds a value to property {@code Drawinterpolated} from an instance of {@linkplain Thing1}.
     ...
     */
	public static void addDrawinterpolated(Model model, Resource instanceResource, Thing1 value) {
		Base.add(model, instanceResource, DRAWINTERPOLATED, value);
	}
     ...
     */
	public void addDrawinterpolated(Thing1 value) {
		Base.add(this.model, this.getResource(), DRAWINTERPOLATED, value);
	}
    ...
    /**
     * Sets a value of property {@code Drawinterpolated} from an instance of {@linkplain Thing1}.
     * First, all existing values are removed, then this value is added.
     * Cardinality constraints are not checked, but this method exists only for properties with
     * no {@code minCardinality} or {@code minCardinality == 1}.
     * Comment from schema: This class acts as a catch-all for all properties, for which no domain has specified.
     ...
     */
	public static void setDrawinterpolated(Model model, Resource instanceResource, Thing1 value) {
		Base.set(model, instanceResource, DRAWINTERPOLATED, value);
	}
     ...
     */
	public void setDrawinterpolated(Thing1 value) {
		Base.set(this.model, this.getResource(), DRAWINTERPOLATED, value);
	}
    ...
    /**
     * Removes a value of property {@code Drawinterpolated} given as an instance of {@linkplain Thing1}.
     * Comment from schema: This class acts as a catch-all for all properties, for which no domain has specified.
     *
     * @param model an RDF2Go model
     * @param instanceResource an RDF2Go resource
     ...
     */
	public static void removeDrawinterpolated(Model model, Resource instanceResource, Thing1 value) {
		Base.remove(model, instanceResource, DRAWINTERPOLATED, value);
	}
     ...
     */
	public void removeDrawinterpolated(Thing1 value) {
		Base.remove(this.model, this.getResource(), DRAWINTERPOLATED, value);
	}
