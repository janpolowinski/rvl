...
public class Identitymapping extends PropertyMapping {
	 ...
	 */
	protected Identitymapping ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Identitymapping ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public static Identitymapping  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
    ...
    /**
	 * Remove rdf:type Identitymapping from this instance. Other triples are not affected.
