...
public class Mapping extends Thing1 {
    ...
    private static final long serialVersionUID = 7328281891505677459L;
	...
	public static ClosableIterator<Resource> getAllFallsbackto_Inverse(Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Property_to_Graphic_Object_to_Object_RelationMapping.FALLSBACKTO, objectValue);
	}
	...
	public ClosableIterator<Resource> getAllFallsbackto_Inverse() {
		return Base.getAll_Inverse(this.model, Property_to_Graphic_Object_to_Object_RelationMapping.FALLSBACKTO, this.getResource() );
	}
	...
	public static ReactorResult<Resource> getAllFallsbackto_Inverse_as(Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Property_to_Graphic_Object_to_Object_RelationMapping.FALLSBACKTO, objectValue, Resource.class);
	}
