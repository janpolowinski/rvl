...
public class Mapping extends Thing1 {
    ...
    private static final long serialVersionUID = 8177691058051210486L;
	...
	public static ClosableIterator<Resource> getAllFallsbackto_Inverse(Model model, Object objectValue) {
		return Base.getAll_Inverse(model, PropertyMapping.FALLSBACKTO, objectValue);
	}
	...
	public ClosableIterator<Resource> getAllFallsbackto_Inverse() {
		return Base.getAll_Inverse(this.model, PropertyMapping.FALLSBACKTO, this.getResource() );
	}
	...
	public static ReactorResult<Resource> getAllFallsbackto_Inverse_as(Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, PropertyMapping.FALLSBACKTO, objectValue, Resource.class);
	}
