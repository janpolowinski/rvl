...
public class Property_to_Graphic_Object_to_Object_RelationMapping extends PropertyMapping {
    ...
    private static final long serialVersionUID = 1470835052365604333L;
	 ...
	 * [Generated from RDFReactor template rule #get11static]
     */
	public static ClosableIterator<Object_to_ObjectRelation> getAllTargetobject_to_objectrelation(Model model, Resource instanceResource) {
		return Base.getAll(model, instanceResource, TARGETOBJECT_TO_OBJECTRELATION, Object_to_ObjectRelation.class);
	}

    /**
     * Get all values of property {@code Targetobject_to_objectrelation} as a ReactorResult of {@linkplain Object_to_ObjectRelation}.
     * @param model an RDF2Go model
     * @param instanceResource an RDF2Go resource
     * @return a ReactorResult of $type which can conveniently be converted to iterator, list or array
	 *
	 * [Generated from RDFReactor template rule #get11static-reactorresult]
     */
	public static ReactorResult<Object_to_ObjectRelation> getAllTargetobject_to_objectrelation_as(Model model, Resource instanceResource) {
    ...
    /**
     * Adds a value to property {@code Targetobject_to_objectrelation} from an instance of {@linkplain Object_to_ObjectRelation}.
     * @param model an RDF2Go model
     * @param instanceResource an RDF2Go resource
     * @param value
	 *
	 * [Generated from RDFReactor template rule #add3static]
     */
	public static void addTargetobject_to_objectrelation(Model model, Resource instanceResource, Object_to_ObjectRelation value) {
		Base.add(model, instanceResource, TARGETOBJECT_TO_OBJECTRELATION, value);
	}
    ...
    /**
     * Sets a value of property {@code Targetobject_to_objectrelation} from an instance of {@linkplain Object_to_ObjectRelation}.
     * First, all existing values are removed, then this value is added.
     * Cardinality constraints are not checked, but this method exists only for properties with
     * no {@code minCardinality} or {@code minCardinality == 1}.
     * @param model an RDF2Go model
	 ...
	 * [Generated from RDFReactor template rule #set3static]
     */
	public static void setTargetobject_to_objectrelation(Model model, Resource instanceResource, Object_to_ObjectRelation value) {
		Base.set(model, instanceResource, TARGETOBJECT_TO_OBJECTRELATION, value);
	}
    ...
    /**
     * Removes a value of property {@code Targetobject_to_objectrelation} given as an instance of {@linkplain Object_to_ObjectRelation}.
     * @param model an RDF2Go model
     * @param instanceResource an RDF2Go resource
	 * @param value the value to be removed
	 *
	 * [Generated from RDFReactor template rule #remove3static]
     */
	public static void removeTargetobject_to_objectrelation(Model model, Resource instanceResource, Object_to_ObjectRelation value) {
		Base.remove(model, instanceResource, TARGETOBJECT_TO_OBJECTRELATION, value);
	}
