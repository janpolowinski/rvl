 ...
 */
public class Mapping extends Thing1 {

    private static final long serialVersionUID = 2914955790305833739L;
	 ...
	 */
	protected Mapping (Model model, URI classURI, Resource instanceIdentifier, boolean write) {
	 ...
	 */
	public static Mapping getInstance(Model model, Resource instanceResource) {
    ...
    /**
	 * Remove triple {@code (this, rdf:type, Mapping)} from this instance. Other triples are not affected.
	...
	public static ReactorResult<Resource> getAllSub_mapping_Inverse_as(Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Sub_mappingrelation.SUB_MAPPING, objectValue, Resource.class);
	}
	 ...
	 * [Generated from RDFReactor template rule #getallinverse1static]
	 */
	public static ClosableIterator<Resource> getAllFallsbackto_Inverse(Model model, Object objectValue) {
	 ...
	 * [Generated from RDFReactor template rule #getallinverse1dynamic]
	 */
	public ClosableIterator<Resource> getAllFallsbackto_Inverse() {
	 ...
	 * [Generated from RDFReactor template rule #getallinverse-as1static]
	 */
	public static ReactorResult<Resource> getAllFallsbackto_Inverse_as(Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Mapping.FALLSBACKTO, objectValue, Resource.class);
	}
