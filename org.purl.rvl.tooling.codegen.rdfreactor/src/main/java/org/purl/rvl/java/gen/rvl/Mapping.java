...
public class Mapping extends Thing1 {
    ...
    private static final long serialVersionUID = 6539949966694710270L;
	...
	public static ClosableIterator<Resource> getAllFallsbackto_Inverse(Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Identitymapping.FALLSBACKTO, objectValue);
	}
	...
	public ClosableIterator<Resource> getAllFallsbackto_Inverse() {
		return Base.getAll_Inverse(this.model, Identitymapping.FALLSBACKTO, this.getResource() );
	}
	...
	public static ReactorResult<Resource> getAllFallsbackto_Inverse_as(Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Identitymapping.FALLSBACKTO, objectValue, Resource.class);
	}
