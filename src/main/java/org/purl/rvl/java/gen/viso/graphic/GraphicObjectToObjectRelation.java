 ...
 */
public class GraphicObjectToObjectRelation extends GraphicRelation {

    private static final long serialVersionUID = 1080684071112947674L;
	 ...
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as RDF resources, that have a relation 'LabelingattachedBy' to this GraphicObjectToObjectRelation instance
	 *
	 * [Generated from RDFReactor template rule #getallinverse1static]
	 */
	public static ClosableIterator<Resource> getAllLabelingattachedBy_Inverse(Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Labeling.LABELINGATTACHEDBY, objectValue);
	}
	 ...
	 */
	public ClosableIterator<Resource> getAllLabelingattachedBy_Inverse() {
		return Base.getAll_Inverse(this.model, Labeling.LABELINGATTACHEDBY, this.getResource() );
	}

	/**
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as a ReactorResult, that have a relation 'LabelingattachedBy' to this GraphicObjectToObjectRelation instance
	 *
	 * [Generated from RDFReactor template rule #getallinverse-as1static]
	 */
	public static ReactorResult<Resource> getAllLabelingattachedBy_Inverse_as(Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Labeling.LABELINGATTACHEDBY, objectValue, Resource.class);
	}
