...
public class SubMappingRelationX {
	...
	public String toStringDetailed(){
		...
		if (hasSubMapping() && hasOnRole()) {
			...
			label += "... to mapping: " + PrintUtils.mappingToStringAsSpecificAsPossible((org.purl.rvl.java.rvl.MappingX)getSubMapping().castTo(org.purl.rvl.java.rvl.MappingX.class)) ;
